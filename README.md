...
Part of the [ProtoConsent](https://github.com/ProtoConsent/ProtoConsent) project. Available on the [Chrome Web Store](https://chromewebstore.google.com/detail/protoconsent/dkcdkdcclhofocmkecccmikkfmfgfdlb), [Firefox Add-ons](https://addons.mozilla.org/en-US/firefox/addon/protoconsent/) and [Edge Add-ons](https://microsoftedge.microsoft.com/addons/detail/protoconsent/djghmcahfjgmeiocpgkdgengofconfoo). Blocklists can be used independently.
